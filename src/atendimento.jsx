  ...
  return (
    <div class="bg-white h-fit flex flex-col justify-center items-center py-[30px]">
      ...
      <a onClick={() => CriaLink(", fui vítima de um golpe do PIX e preciso de seu atendimento.")}
        class="p-4 w-[90%] md:w-[690px] h-fit py-[20px]  bg-[#3148D2] text-[19px] flex flex-row text-center items-center justify-center font-medium text-white rounded-3xl cursor-pointer mt-[30px]  ">
